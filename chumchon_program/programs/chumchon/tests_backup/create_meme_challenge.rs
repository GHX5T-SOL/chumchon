...
#[tokio::test]
async fn create_meme_challenge_ix_success() {
	...
	let prompt: String = Default::default();
	let reward_amount: u64 = Default::default();
	...
	let ix = chumchon_ix_interface::create_meme_challenge_ix_setup(
		&fee_payer_keypair,
		challenge_pda,
		&creator_keypair,
