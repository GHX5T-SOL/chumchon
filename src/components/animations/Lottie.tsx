...
export function LoaderLottie({ style }: { style?: StyleProp<ViewStyle> }) {
  return (
    <Lottie source={null as any} style={[{ width: 140, height: 140 }, style]} />
  )
}

export function SuccessLottie({ style }: { style?: StyleProp<ViewStyle> }) {
  return (
    <Lottie source={null as any} style={[{ width: 120, height: 120 }, style]} />
  )
}

export function WalletSuccessLottie({ style }: { style?: StyleProp<ViewStyle> }) {
  return (
    <Lottie source={null as any} style={[{ width: 160, height: 160 }, style]} />
  )
}
